...
const Home = () =>{
   ...
   /*        <h2>Mira las mejores pelis en casa </h2>
          ...
          <Link to={/Peliculas} className="btn btn-secondary">Ver Peliculas</Link> 
      ...
      <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          ...
          <div className="carousel-item" data-bs-interval="2000">
            <img src={reactslider2} className="img-fluid w-90" alt="..." />
          </div>
          <div className="carousel-item">
            <img src={reactslider3} className="img-fluid w-90" alt="..." />
          </div>
        </div>
        <h2>Mira las mejores pelis en casa </h2>
        <img src={reactLogo} className="logo react" alt="React logo" width="150" height="150" />
          {/* <Link to={/Peliculas} className="btn btn-secondary">Ver Peliculas</>  */}
          {/* <img src={reactLogo1} className="logo1 react" alt="React logo1" width="300" height="450" /> */}
      </div>
)
}
